...
\addtoindex{
    Listening!For higher music;
    Cererols, Joan|(;
    Montserrat!Abadia|(;
    Montserrat!Escolania;
    Spheres;
    Cosmos;
    Verbum infans;
...
\fullcite[34]{Laplana:MontserratMuseu})}
% XXX permission?
%}}}4
...
\addtoindex{
    Canet de Mar!Parròquia de Sant Pere i Sant Pau;
    Catalonia
}
...
{\wtitle{Suspended, cielos}, coplas as set by Cererols}
%}}}4
...
\addtoindex{
    \Palestrina;
    Musical topics!Learned style|seealso{Counterpoint!Symbolism}
}
...
\addtoindex{
    Science!Astrology;
    Astrology|see{Science!Astrology};
    Science!Astronomy;
    Copernicus, Nicolas;
    Kepler, Johannes;
    Newton, Isaac;
...
(\figref{fig:BMV-Montserrat}), the musical terms here are specific to the
...
(S1, source listed in \tabref{tab:suspended-sources}; F1, hypothetical source
\add{\foreign{fuente}})}
%}}}4

Family B descends from a recension by Manuel de León Marchante, who somewhat
simplified the earlier version.%
    \Autocite{LeonMarchante:Obras1733} % XXX page no
...
\wtitle{Voces, las de la capilla} (\chapref{ch:gdp-voces}), León Marchante
...
\addtoindex{
    ...
    \IrizarM;
    Segovia!Cathedral;
    Miciezes, Tomás (elder);
    \CasedaD;
    Zaragoza;
    Xuárez, Alonso;
    Suárez, Alonso|see{Xuárez, Alonso};
    Seville!Cathedral;
    Seville!San Salvador;
...
\addtoindex{
    Ibarra, Ecuador!Conceptionist convent;
    Villancico!Performance practice;
    Convent music
}
