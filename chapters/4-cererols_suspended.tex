...
lines, but instead all agree with the Canet version for Christmas.
...
It is a more homophonic, melody-oriented style featuring dissonances used
...
Newton into Spanish universities, but during the period in which the
...
Kircher makes a similar gesture in a different passage, where he describes the
...
appeal of this topic, but also suggest that as the century progressed people
began to see it as simply an attractive poetic conceit, missing the intricate
theological complexity of the earlier sources.
