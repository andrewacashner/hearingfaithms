...
hung mysteriously among the columns of the new cathedral's architectural choir.%
...
\term{en mi}) and allusions to liturgical chants (\term{Gloria} and perhaps the
\term{Gratias agimus tibi}).
The musical imagery continues the conceit of the King as musician, a
\foreign{padre} (father, priest) like Gutiérrez de Padilla and many other
...
1642 (see\tabref{tab:Voces-Cantores-settings}), the first sixteen lines are
divided into four quatrains, with the same text as Gutiérrez de Padilla's
\poemlines{1--16}.  But in the version sung in Puebla in 1657,
\poemlines{1--6} and \poemlines{11--16} are grouped together and each is
followed by \poemlines{7--10}, now repeated as a \term{respuesta}.
...
For the word \foreign{cuenta} at the beginning, he not only has one choir
...
through the subsequent elaborations of this concept by Augustine in the fifth
...
(\poemlines{11, 23}).
The beginning of Christ's human life is the moment when the idea is
\quoted{clothed in the voice} and communication becomes possible.
...
Seville are shown in \tabref{tab:Puebla-Seville-MCs}.
...
Francisco de Santiago first served as assistant to Alonso Lobo during his old
age in 1616.%
    \Autocites
...
\begin{quoting}
    Come and see the Son of God, not in the bosom of the Father
    \add{\scripture{Jn 1}}, but in the arms of the Mother; not above choirs of
    angels, but among filthy animals; not seated at the right hand of the
    Majesty on high \add{\scripture{Heb 1}}, but reclining in a stable for
    beasts; not thundering and casting lightning in Heaven, but crying and
    trembling from cold in a stable.%
...
Based on the position of this villancico in the manuscripts, it was most likely
