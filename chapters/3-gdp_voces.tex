...
\addtoindex{
    ...
    Introduccion@Introducción|see {Villancico!Structure};
...
\addtoindex{
    Zurbaran, Francisco@Zurbarán, Francisco;
...
\addtoindex{
    \JoaoIV;
    Jalon, Luis Bernardo@Jalón, Luis Bernardo;
...
\addtoindex{
    Malaga@Málaga!Cathedral;
    Vasquez, Francisco@Vásquez, Francisco;
    Brito, Estevao de@Brito, Estevão de;
    Puebla!Cathedral;
    \FernandezG;
    Garcia de Cespedes, Juan@García de Céspedes, Juan
}
...
\addtoindex{
    Visual art;
    Puebla!Cathedral;
    Garcia Ferrer, Pedro@García Ferrer, Pedro;
