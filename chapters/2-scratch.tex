...
% See work on limpieza de sangre, marranism, conversos, moriscos, Pagden, etc.

% Conclusion about Judaism, likewise
...
forced, and many Spaniards with \soCalled{purity of blood} Spaniards doubted the
sincerity of the \term{conversos}, calling them \term{marranos} or pigs.%
    \Autocite[\sv{marrano}]{NewCatholic}
