...
\end{Footnote}
But even as the catechism stresses that sensory experience is inadequate, and human beings incapable of knowing God by their own lights, it still speaks of the knowledge of God in subjective terms: \quoted{our minds} must be changed, our relationship to the world of the senses must be changed by divine action.
...
As Susan Schreiner argues, the Catholic response to early modern debates about the certainty of faith and salvation was to emphasize the work of the Holy Spirit through the institutional Church. %XXX check
...
The contrast between this passage and the quotation from Kircher reflects not only a chronological change in Catholic attitudes between the late sixteenth and mid seveteenth centuries, but also a contrast between religious orders, and differing emphases on parts of the Christian life.
...
Bringing a man to faith meant setting him on a path to becoming a whole, virtuous person in the image of Christ, a \term{virum perfectum} in the words of the catechism, the root of \term{virtus} being \gloss{vir}{man}.%
...
% XXX START insert trimmed-down material from long version line 657+
...
One possible performance venue for this piece would have been the Monasterio de la Encarnación in Madrid, where the Royal Chapel frequently performed.%
\citXXX[Royal Chapel]
...
% instructing the senses, training the senses through experience, not just teaching
...
In a piece labeled \foreign{sordo} in the partbooks, Juan Gutiérrez de Padilla creates a comic dialogue between a religious teacher and a \soCalled{deaf} man named Toribio (\ref{expoem:Oyeme_Toribio-Padilla}).
