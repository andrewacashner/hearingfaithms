...
(\figureref{fig:Galan-Oigan-coloratio}).
...
melodic sequence (\figureref{figure:Padilla-Sordo-MS-estribillo}).
...
(\figureref{Covarrubias-ears-thorns}), whose dictionary definition of deafness
...
\begin{figure}
    \includeTallFigure{Covarrubias-ears-thorns}
    \caption{\quoted{Sepi aures tuas spinis}, from
    \textcite[202]{Covarrubias:Emblemas}}
    \label{fig:Covarrubias-ears-thorns}
\end{figure}
