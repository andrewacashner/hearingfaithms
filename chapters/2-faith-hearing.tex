...
found in Christ's own words in \scripture{Jn 17:3}: \quoted{This is eternal 
...
All the Church's teachers should exert themselves to the end that 
    \begin{quote}
        ...
        crucified \add{\scripture{ICor 2:2}}; and indeed to persuade them so that they 
        believe with the faithfulness \add{\foreign{pietas}} of their inmost heart and 
        with cultivated devotion \add{\foreign{religio}}, that there is no other name 
        ...
        oporteat nos saluos fieri: siquidem ipse propitiatio est pro peccatis nostris}.]
            {Catholic:Catechismus1614}
    \end{quote}
...
pietatem, fidem, charitatem, manusetudinem: dedit enim semetipsum pro nobis, vt 
...
\begin{quote}
    ...
    accommodate the teaching to the sense of hearing and intelligence}, so that by 
    these \add{mysteries and precepts}, \emph{those whose senses have been trained} 
...
This concept was echoed in 1589 Spanish \worktitle{Catechism of the Mysteries 
...
\begin{quote}
    ...
    should understand that Faith enters through the ear \add{\foreign{oído}}, as 
...
\end{Footnote}
Kircher discusses the power of music several times throughout his ten-volume 
...
king.%
    \begin{Footnote}
        ...
        della musica} (Florence, 1581), 90, in discussing the Classical source, Dio 
        Chrysostom, \worktitle{Orationes} 1 (\textgreek{Περὶ Βασιλείας});  a later 
        treatment of this subject is John Dryden, \worktitle{Alexander's Feast, or the 
...
\begin{quote}
    ...
    cœlestium, meditationi deditum in exoticos affectus raptusque mentis commouere 
    ...
    statim extra se factos dulcedine harmonica eò, vbi vera sunt gaudi rapi: vidi 
...
\begin{quote}
    ...
    ascensus, descensusque ratione varius sit, spiritus quoque, siue aer internus 
...
\quoted{Music does not just move any subject, but that with which the natural 
humor of the music is congruent \Dots{} for unless the spirits of the recieving 
...
In other words, the tension between acccommodating hearing and training it is 
...
Exercises} to discern the validity of their religious sensations.%
...
\begin{quote}
    ...
    is the fruit that he gains though his style be low and his rhetoric scanty, and 
    ...
    style and actions and elevated doctrine and good language move and create more 
    effect when accompanied by a good spirit, without the spirit, though the sermon 
    may give the sense and understanding much to savor and enjoy, it infuses little 
    or no sustenance to the spirit, because commonly it remains as lax and loath as 
    before to labor, even though marvelous things were said in marvelous ways, 
    which only serve to delight the ear \add{\foreign{oído}}, like some polyphonic 
    music \add{\foreign{una música concertada}} or the clanging of bells \Dots{}.
...
As Ines Żupanov describes Jesuit intercultural encounters in India in her book 
...
Iberian musicl centers discussed in this study: on the outgoing trip, Lisbon, 
...
In Colloquio XI of the dialogue, Michael, on of the \soCalled{ambassadors}, 
...
faith.
% \citXXX[Pagden?]
Someone who was not completely a \term{vir}, after all, could not be expected 
to arrive at the fullness of \term{virtus}; but still most writers concluded 
...
could be found to overcome the \quoted{impediment} of non-European listeners' 
\quoted{normal expectations in listening to singing}, as the Japanese 
...
\tableref{table:senses-fray-luis} shows how Fray Luis explains the relationship 
...
senses by means of the ethereal \term{spiritus animales}.
...
\begin{Footnote}
    \Autocite[\sv{battle music}]{Grove}{Sutton:IberianBatalla}, who discusses 
    examples including those in Martín y Coll's \worktitle{Huerto ameno de flores 
...
armoníá}, which almost takes on the dimensions of a \term{cantada}.%
...
The style similar to the \soCalled{high Baroque} music of contemporary Italy, 
...
Carrión dramatizes \foreign{queja} (\measurenum{2}) with a metrical 
...
\measurenums{18--20} that leads the singer to the top of his register.
The upward leaps in the last line on \foreign{no se den} (\measurenum{16}) 
...
\begin{Footnote}
    ...
    \quoted{synthesis of the senses} in Spanish verse and the actual neurological 
...
%*******************
\begin{exmusic}
    \includeScore{Padilla-Sordo-responsion}
...
\emph{able} to hear.
He adds, \quoted{There is no worse kind of deaf man than he who is unwilling to 
hear}.%
\begin{Footnote}
...
the phrase \foreign{los que no escuchan ni entienden el son}.
This pattern bears a close resemblance to dance forms known as \term{son} today 
(\exmusicref{exmusic:Ruiz-Sordos-son})---most obviously, to the Mexican 
\term{huarache} familiar from Leonard Bernstein's \quoted{America}.%
...
\begin{exmusic}
    ...
    estribillo, \measurenums{76--83}: Possible evocation of \term{son} song/dance 
    style}
...
(\figureref{figure:Covarrubias-ears-thorns}), whose dictionary definition of deafness
...
yourself save, take refuge in Christ and his crown}.%
    \Autocite
...
\begin{figure}
    ...
    \textcite[202]{Covarrubias:Emblemas}}
    \label{figure:Covarrubias-ears-thorns}
\end{figure}

Even if, then, the Church successfully made Christ the Word audible to the world,
