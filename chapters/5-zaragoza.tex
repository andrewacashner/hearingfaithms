...
\index{Daroca!Santa Maríá de los Sagrados Corporales}
\index{Zaragoza!El Pilar}
...
\index{Villancico!Liturgical function!Eucharistic devotion}
\index{Villancico!Dedications!Al Santísimo Sacramento}
...
\index{Analysis!Poetry!Textual variants}
...
\index{Analysis!Music!Text depiction}
\index{Analysis!Music!Formal structure}
...
\index{Analysis!Music!Text expression}
\index{Affect}
\index{Bruna, Pablo|)}
%}}}2
...
\index{Analysis!Poetry!Vocabulary}
\index{Mexico City!Cathedral}
\index{Cythara}

%{{{4 Caseda poem
\begin{poemexample}
    \caption{\wtitle{Qué música divina}, poem as set by José de Cáseda}
...
\index{Interpretation!Poetry!Theological}
...
\begin{figure}
    ...
    instrumentos musicales}, 110r}
    \label{fig:Bermudo-vihuela7}
    \includefloat{Bermudo-vihuela7}
\end{figure}
%}}}4
...
\index{Intabulation}
\index{Villancico!Use with instruments}
\index{\PueblaConvento}
...
\index{Ruíz de Ribayaz, Lucas}
\index{Rhetoric}

%{{{4 Ruiz strumming
\begin{figure}
    \caption{Strumming patterns in Ruíz de Ribayaz, \wtitle{Luz y norte
    musical}} 
...
\index{Analysis!Music!Representation}
...
\index{Analysis!Music!Counterpoint}
