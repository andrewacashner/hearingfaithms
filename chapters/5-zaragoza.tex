...
striking Phrygian cadence in which the Alto leaps upwards into an unprepared
seventh.  
...
The later setting in this villancico family was composed by Miguel Ambiela
...
Ambiela's version of \wtitle{Suban las voces} could have signaled to listeners
...
\begin{Footnote}
    ...
    should enter on the fourth semiminim of \measure{23}.
\end{Footnote}
...
that name.
The same writer also copied his own bajón part and, at the top of the
...
As Calahorra noted, Ambiela treats the repeat of the estribillo after the
coplas differently than Bruna as well.
...
In both texts, music is represented as voices rising to heaven from souls
...
ARDET}.%
    \Autocite[\folio{290\textsuperscript{r--v}}]{Covarrubias:Emblemas}
...
the Tiple 1 part belonged to \quoted{Tomasita}, the Tiple 2 to \quoted{María
...
\quoted{a new song before the throne}, and the Latin follows the Greek in
...
\term{G (gamma, ut)}, that is, \pitch{G}{2}.%
    \Autocite[\folio{109\textsuperscript{r--v}}]{Bermudo:Declaracion}
...
The piece begins with the Tiple 1 (sister Tomasita in Puebla) singing a solo
...
Again in \measure{2}, when the Tiple 1 makes the striking leap up to the
...
In the opening gesture, the Tiple 1 sings her solo with continuo accompaniment,
...
\begin{quoting}
    ...
    singing it they would recognize the falsehood \addorig{falsedad}.% 
        \Autocite[\folio{128\verso}]{Bermudo:Declaracion} 
\end{quoting}
Direct and even parallel fifths do indeed appear regularly in the notated
examples of vihuela harmonization.%
...
in the Tiple 2 to resolve up to F.
...
wedge is created.
As this is happening, in \measure{61}, the Tiple 1 enters from out of nowhere
...
consonance with the Bass, but against the E flat in the Tiple 2 it certainly
...
The Tiple 2 might begin the last phrase (starting in \measure{34} on F),
...
Either option clashes with the notated F sharp in the Tiple 1.
In \measures{69--70}, on \foreign{potencias desmaya}, the ficta situation becomes
actually impossible.
To maintain the fugal motive, the Tiple 2 would have to sing three minim B
flats and then a semibreve B natural, leading up to C.
But in the same place as the Tiple 2 B flats, the Tenor has a notated sharp
...
these problems (probably by singing all B naturals in the Tiple 2).
...
(\scripture{1Cor 13:1}) if they did not convert hearers of the word into doers
(\scripture{Jas 1:22}).
