...
In a piece called \VCtitle{Sagrado pajarillo} (Little sacred bird), Zaragoza composer José de Cáseda sets the lyrics \quotedgloss{con gorgeos}{with trills} to twittering melismas (\exref{example:Caseda-Sagrado_pajarillo}).
...
\label{example:Caseda-Sagrado_pajarillo}
\inputexample{Caseda-Sagrado_pajarillo}
\end{example}
%**********
