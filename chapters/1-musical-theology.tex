...
\exmusiclabel{Padilla-En_la_gloria}
\end{exmusic}
%**********
...
In a piece called \VCtitle{Sagrado pajarillo} (Little sacred bird), Zaragoza composer José de Cáseda sets the lyrics \quotedgloss{con gorgeos}{with trills} to twittering melismas (\exmusicref{Caseda-Sagrado_pajarillo}).
...
\exmusiclabel{Caseda-Sagrado_pajarillo}
\end{exmusic}
%**********
