...
\foreign{Concierto tan soberano} (\cref{mux:Cererols-Suspended-concierto}).
...
of musical representation (see \cref{ch:intro}).
...
son and successor José (possibly brought there by Dallo y Lana).%
