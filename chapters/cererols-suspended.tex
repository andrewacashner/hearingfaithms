...
\quote{fugue} (the same word as \quote{flight}, like the musical term
...
\begin{table}
    ...
    estribillo}
    \label{tab:suspended-urquelle}
    \includeTable{suspended-urquelle}
\end{table}
%}}}4
...
\begin{poemexample}
    ...
    \term{Suspended, cielos} tradition, earliest version (source \XXX)}
    \label{poem:Ha_de_los_coros}
    \includePoem{Ha_de_los_coros}
\end{poemexample}
%}}}4

% START notebook 29 page 44
