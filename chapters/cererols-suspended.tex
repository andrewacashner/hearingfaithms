...
practice of villancicos like those of Cererols (\cref{fig:BMV-Montserrat}).%
    \Autocite[\XXX]{Laplana:MontserratMuseu}

%{{{4 fig Mare de Deu
\insertFigure{BMV-Montserrat}
{\wtitle{Mare de Déu de Montserrat}, 17th cent., Abadia de Montserrat, detail
showing Escolania}
% TODO permission?
%}}}4
...
\begin{Footnote}
    This example should challenge the assumptions of those scholars of both
    Spanish and non-Spanish music who have assumed that Spanish musicians did
    not draw on new Italian styles until the rise of the \term{galant} style in
