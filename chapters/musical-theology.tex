...
The survey found nearly nine hundred extant, cataloged villancicos that reference musical themes, a number that only hints at the original size of this repertoire (\tref{table:metamusical-survey}).
...
\subsection{Pieces with Multiple Topics: Padilla and Cererols}
...
In just the first seven lines of this anonymous text (\poemref{poem:Padilla-En_la_gloria}), the villancico refers to sound, voices, singing, choirs, dancing, birds, and solmization.

%**********
\begin{poem}
\caption{\VCtitle{En la gloria de un portalillo}, estribillo as set by Padilla, Puebla Cathedral, Christmas 1652 (\signature{MEX-Pc}{Leg.~1/2})}
\label{poem:Padilla-En_la_gloria}
\inputpoem{Padilla-En_la_gloria}
\end{poem}
%*********

Padilla's setting demonstrates several typical features of the genre (\exref{example:Padilla-En_la_gloria}).
...
%**********
\begin{example}
\caption{Padilla, \VCtitle{En la gloria de un portalillo}, Puebla Cathedral, Christmas 1652 (\signature{MEX-Pc}{Leg.~1/2}), estribillo (\measures{6--17})}
\label{example:Padilla-En_la_gloria}
\inputexample{Padilla-En_la_gloria}
\end{example}
%**********
...
The piece seeks a theological meaning behind the Christmas customs: the masques of Christmas, the poem says, are appropriate because in the Incarnation of Christ, \quotegloss{Dios se disfraza}{God masks himself}. 
...
\subsection{Imitative References to Music: Topics of Instruments, Birdsong, and Dance}
