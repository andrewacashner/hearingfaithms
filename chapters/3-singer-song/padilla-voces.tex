...
Christ's life \quoted{is putting notes to his lyrics} (\poemlines{8--9}), and thus
...
The second section of the introduction (\poemlines{11--16}) depicts the moment of
...
the half-measure of night}, \poemline{15}) and a symbol of his royalty, the same
...
whole creation of humans, animals (\foreign{hombres y brutos}, \poemline{20}; also
the reference to bidsong in \poemline{16}),
...
re)}} as a symbol of Christ himself, which we will discuss in more depth below.
The song is \quoted{as much to be seen (or admired) as to be heard}---because
...
everything in God is to descend} (\poemlines{32--33}).
