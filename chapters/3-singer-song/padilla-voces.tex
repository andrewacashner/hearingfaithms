...
the poetry.
Aside from the symbolic meanings of the two changes of meter (\measure{45} and
\measure{60}; see below), these shifts match the stress patterns implicit in
...
The internal cadences in the \term{introducción} are on G (\measure{19}), D
...
Padilla sets \quoted{the lightest dissonance} in \measures{14--19} by having the
Altus I suspend across the first minim of \measure{18}, making a dissonant
seventh against the Tenor's A---a light dissonance that quickly resolves to
F\sh{} and then to a cadence on G in \measure{19}.
On the repeat of this section, it is easy to imagine that an experienced trble
singing about \quoted{the trills of the dawn} in \measures{25--27} would have
...
with the estribillo in \measure{45}, where the \meterC{} sign indicates a shift
