...
sung or played intonation.%
    \autocite[For examples of keyboard intonations, see]
    [\XXX]{keyboard_intonations}
...
The phrase \foreign{a lo de} (in the manner or style of) ipmlies that the
...
The listener now hears singing (\foreign{cantar}), in the form of a song (\foreign{canto}).
...
eighth notes).%
    ...
    las voces al cielo} in \cref{ch:zaragoza}):]
    [\XXX]
    {Cerone:Melopeo}
...
de Cáseda's \wtitle{Qué música divina} (see \cref{ch:zaragoza}).
...
Fray Luis explicitly compares the voice of this incarnate Word with music.  The
Dominican friar, an avid student of Catholic Humanism, presents Christ as an
orator and philosophical teacher, a \quoted{Master of
...
la capilla} (\cref{tab:Voces-Cantores-settings}).
...
coherent 
(\crefrange{tab:Voces-versions-1}{tab:Voces-versions-3}).
