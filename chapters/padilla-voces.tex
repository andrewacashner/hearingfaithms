...
is the seed of glory, and in turn glory is the consummation of grace}.%
    ...
    {Lapide:Gospels19C}
    [Cf.] 
    [98, Sermo 185, In Natali Domini 2, in connection with \scripture{Rom}{0:0}]
...
(\scripture{Gn}{0:0}), here referring not only to the animals in the stable, but
also to the whole scene as a picture of the Christian church, a symbolic
connection going back to the first century (\scripture{IPet}{:8-22}).%
...
which he died (\scripture{Mk}{17:0}).
...
last, the beginning and the end} (\scripture{Rev}{23:}).%
    \footnote{See also \scripture{Rev}{1:8,21:6}.}
...
NRSV). 
% XXX check all scriptural cites
...
\scripture{John}{2:0}: \quoted{God gives the power to become sons of God to
...
within her heart} (\scripture{Lk}{2:9}).
