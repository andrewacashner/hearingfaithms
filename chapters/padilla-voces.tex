...
As the second copla encapsulates the conceit, Christ is a divine musical
...
known as \term{oposición}, God demonstrates his mastery by creating concord
...
(\scripture{IChr}{25:}).
The poem explicitly identifies Jesus as the royal \foreign{infante}---heir to the
throne.
As a human, Jesus was the Messiah, heir to David's throne; as divine, he was the
Son of God, second person of the Trinity.
The phrase \foreign{a lo de} (in the manner or style of) suggests that this
...
As the interpreter Cornelius à Lapide puts it, \quoted{Grace, therefore,
is the seed of glory, and in turn glory is the consummation of grace}.%
    \Autocites
    [878, on \scripture{Jn}{1:} \XXX{check}] {Lapide:Gospels19C}
    [Cf.] [98, Sermo 185, In Natali Domini 2] {Augustine:SermonesPL}
