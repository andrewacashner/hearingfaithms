...
at 11 p.m.%
\begin{Footnote}
    The schedule was set by decree of the cathedral chapter; see
    \cref{fn:Puebla-Matins-time}.
\end{Footnote}
...
Bernardo Illari describes as \quoted{enigma} villancicos.%
    \Autocite[\range{vol}{2}, 304--308]{Illari:Polychoral}
...
beginning and end} (\scripture{Rv}{23:}): \quoted{just as no letter comes
