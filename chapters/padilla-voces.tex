...
This poem exemplifies the technique of \term{conceptismo}; here the two
...
When the poem refers to \quoted{the sign of \emph{A (la, mi, re)}}, it means
...
Latin-texted music today, the \wtitle{Missa \quoted{Ego flos campi}} for eight
voices.%
\begin{Footnote}
...
they went and told everyone, and those who heard \quoted{went forth praising
and glorifying God for everything they had seen and heard}
(\scripture{Lk}{9:}).
...
If the listeners were to imitate the shepherds, then, they would not only
...
emphasis on wonder, amazement, even \quoted{stupefaction} (to use Lapide's
