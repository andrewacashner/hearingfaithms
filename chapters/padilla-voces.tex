...
and deliver his people (\scripture{2Sam 7}), and through Isaiah the prophet
...
animals on Noah's Ark (\scripture{Gn 5}), here referring not only to the
...
tone and the F--E--D in the Tenor and then Tiple matches the final cadence
...
on} (see \cref{fn:Puebla-Matins-time}).
...
him, \quoted{for he is God}.%
    ...
    %XXX don't cite Palafoxiana ex libris here; check Patrologia Latina instead
