...
\begin{Footnote}
    \sig{L:Pn}{RES-189-1-p (\itemnum{2})}; 
...
%{{{4 figures Puebla Cathedral x2
\insertFigure{Puebla-Ferrer-Retablo}
{Puebla Cathedral, Retable of the \quoted{Altar of the Kings}, Pedro García
Ferrer and studio, consecrated 1649}
  
\insertFigure{Puebla-Ferrer-BMV}
{Puebla Cathedral, retable, \wtitle{Assumption of the Virgin} (detail)} 
%}}}4 
...
%{{{4 figure Ferrer pastores
\insertFigure{Puebla-Ferrer-Pastores}
{Ferrer, \wtitle{Adoration of the Shepherds}, retable of Puebla Cathedral}
%}}}4
