...
%{{{2 imitation: instruments etc.
\subsection{Imitative References to Music: Topics of Instruments, Birdsong,
Dance}
...
%{{{2 abstract references: solfa, nonsense
\subsection{Abstract References to Music: Singing about Singing, Solmization, Nonsense}
...
%{{{3 ethnic vcs
\subsubsection{Mixed References in \quoted{Ethnic} Villancicos}
...
%{{{2 music itself as a conceit
%{{{3 vcs about vcs
\subsection{Villancicos about Villancicos}
...
%{{{3 sign and signified
\section{Sign and Signified}
