...
% XXX check WLSCM32, articles for repetition
...
(\term{chirimías}) and brass instruments like sackbuts (\term{sacabuches}).%
    \citXXX[instrumentation, performance practice]
...
for a motet.%
    \citXXX[Torrente-estribillo-Reichenberger]
...
\begin{Footnote}
    \Autocite[\XXX]{Illari:Polychoral}
    \citXXX[statdpfeiffer, praetorius cd, ministriles]
\end{Footnote}
...
signals of divinely ordained seasons and times.%
    \citXXX[archeology, symbolism of biblical trumpets]
...
\begin{Footnote} 
    ...
    \Autocite{Favila:PhD} \citXXX[new favila art]
\end{Footnote}
...
chapelmaster of Mexico City Cathedral from 1679.%
    ...
    % XXX general reference to composer entries in DMEH
...
within the Neoplatonic cosmos.
Since earthly music of any kind, metamusical or not, would always point beyond
itself to higher forms of music and ultimately to God, metamusical pieces call
the listener's direct attention to the artifice of the music itself.
...
A collection of printed sermons by Fray Andrés de San
Miguel of Puebla includes a sermon this Carmelite preacher gave to a
gathering of Salazar's own confaternity.%
    \citXXX[san miguel sermon]
Fray Andrés explicitly thanks Salazar for commissioning the sermon, and says
they are gathered in the \quoted{church of the Incarnation}, possibly the
...
\term{Ut} reminds us of the angel's Hebrew name, rendered in Latin as
\foreign{Quis ut Deus}; \term{re} (king) reminds us that Michael is the chief
...
address the angels directly (since angels were believed to be present at every
liturgy, \scripture{ICor}{11:10}), while they also stand in for, or sing along
