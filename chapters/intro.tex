...
poetry---\term{villancicos}---in the church's liturgies and festivals.
...
In their seventeenth-century heyday, villancicos were a genre of complex musical
...
There were many kinds of villancicos with varying functions, but nearly all
...
%{{{1 vcs about music as key to theological understanding of music
%**************************************
\section{%
...
%{{{1 neoplatonic theology of music
\section{%
...
%{{{1 theory of three functions of VCs
\section{%
