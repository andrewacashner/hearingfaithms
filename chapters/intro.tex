...
listen---\foreign{Atended}, \foreign{Escuchad}, \foreign{Oíd}---and a large
...
Metamusical villancicos brought together musical and theological knowledge---two
domains in which every educated Spaniard had received instruction---into a
mutually illuminating relationship.
...
Their performances constituted a major element of the soundscape of the
early modern Ibero-American world, and shaped the everyday experiences of
thousands of people across social strata.
...
The goal of this project is not to provide a comprehensive musicological
treatment of the genre in all its aspects, but to use select examples of this
genre to reach a deeper understanding of early modern religious culture.
...
to this multifaceted genre, but that we will never fully understand villancicos
without understanding their role first and foremost as expressions of religious
belief; and we will not understand them theologically without a deep engagement
with the way the pieces sound.
Whether as a result of anti-religious or anti-Catholic bias or some other
factors, few scholars have taken this genre seriously as a source for
understanding historical religious beliefs and practices.
Several of the major musicological studies of villancicos do not engage with
the meanings of the words at all.
Unfortunately the music of villancicos has also received inadequate scholarly
attention, in line with a trend in recent studies of musical life in the
Spanish Empire to downplay or even completely ignore musical texts.
...
This does not require the interpreter to agree with those beliefs.
...
Until more evidence comes to light for choreographed villancicos, though, we
may presume that the references to dance were meant to invoke dance as a
concept and make use of its symbolic meanings.
...
popular novels---using underworld slang and in some cases graphic sexual
language.
...
case, \quoted{from way up in Texas}; in the words of one piece, the performers
\quoted{present as a dish of the court what really is feed from the village}.%
    \citXXX[sources]

% TODO example comparing successive jacara tunes to secular sources

That piece, \wtitle{A la jácara, jacarilla} of 1655, exemplifies the verbal
virtuosity prized in this subgenre: in the text, borrowed from the imprint of a
piece performed in Madrid the previous year, every line of the coplas is
built from \foreign{principios de romances}, the first lines of traditional
\term{romance} ballads---an ingenious secret only hinted at in the final verse.
The music, too, is a bold and witty mixture: the core of the setting is based
on the secular dance, but each year Gutiérrez de Padilla made the setting more
complex, contrapuntally and rhythmically.
...
The contrast between \term{corte} and \term{villa} here between noble and
common, gentility and laborers, urban and rural, refined and crude---but
notably not sacred and secular.
...
Gutiérrez de Padilla combines the style and specific motives of a low-life
ballad genre with the techniques of learned counterpoint; he actually seems to
amplify the complexity of the oral source material beyond what would more
commonly be improvised.
...
Christmas, celebrating that the most high God had submitted to be born as a
helpless child and manifested to lowly shepherds and heathen magi (see
\cref{ch:padilla-voces}).

Later \term{jácaras} lose many of the explicit connections to their worldly
origins and become another conventionalized subgenre of villancicos, continuing
to display ingenuity but likely losing the original connection to the world
outside the church.
Mateo de Villavieja's \term{Jácara en anagramas} plays with permutations of a
set of textual and musical elements in an early example of algorithmic
composition, but retains none of the musical or poetic elements of earlier
\term{jácaras}.
...
(\cref{mux:Padilla-Miraba_el_sol-hexachords}).
...
% %{{{5 music GdPadilla Miraba el sol hexachords
% \insertMusic{Padilla-Miraba_el_sol-hexachords}
% {Gutiérrez de Padilla, \wtitle{Miraba el sol}, estribillo: Hexachordal shift
% symbolizing Mary/Eagle in \term{mollis} turning to Christ/Sun (\term{sol}) in
% \term{naturalis}}
% %}}}5
% XXX problem for makefile: float is tex file incorporating music file
