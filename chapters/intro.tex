...
\quoted{What soverign harmony is this which elevates hearing?}
...
% TODO GdPadilla Cuando mira el sol
...
Even when solmization passages seem to lack lexical or symbolic meaning,
though, they bear a profound theological meaning as an embodiment of the voice
itself, within the Neoplatonic system (explained more fully below).
...
\begin{Footnote} 
    ...
    (Eriugena), \quoted{Each mortal thing does one thing and the same:/ Deals
    out that being indoors each one dwells; Selves---goes itself; \emph{myself}
    it speaks and spells;/ Crying \emph{What I do is me: for that I came.}}
    \quoted{As kingfishers catch fire}, in \autocite[95]{Hopkins:Poems}.
\end{Footnote}
...
%}}}3 
% TODO CUT, maybe incorporate bits in relevant sections above; or replace with
