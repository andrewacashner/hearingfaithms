...
As a musical genre, \term{villancicos} were settings of villancico poems.
...
As a rule villancicos do not, then, embody a single viewpoint, being more than
...
history, and on verbal discourse \emph{about} music.%
    \Autocites{BakerKnighton:MusicUrbanSociety}
    {Irving:Colonial}
    {DellAntonio:Listening}
% TODO more lit
A few of these studies, in their emphasis on critiquing colonial power,
deliberately exclude notated music from consideration.%
    \Autocites[\XXX]{Baker:Harmony}
    [\XXX]{RamosKittrell:PlayingCathedral}
On the other hand, other studies focus only on the music of villancicos and do
not engage with the meaning of the words!%
    \Autocite{Swadley:PhD}
...
We will never fully understand villancicos without understanding their role
first and foremost as expressions of religious belief.
Moreover, we will not understand them theologically without a deep engagement
with the way the pieces sound.

This book concerns theology as a historical practice; it is not a book of
contemporary constructive theology.
I am a Christian but not a Roman Catholic, and certainly I do not share the
prescientific worldview of early modern Spaniards.
But interpreting villancicos requires us to set aside our own religious
ideas---or anti-religious ideas---in order to hear the world through
...
and the writings of the early church (patristics) and more recent theologians.
...
setting as well.
I propose that we understand \term{conceptismo} in the this context as a
specific literary form for doing a certain kind of theological thinking.
...
The sources for this music come from nine archies in Mexico, Spain, the United
States, and the United Kingdom.
I have edited almost all of the pieces studied from the original manuscript
music sources and printed poetry sources.
...
dates---and because this composer appears to have been especially fond of
writing music about music.
%}}}3
%}}}2
%}}}1
