...
\epigraph{%
\foreign[\la]{ergo fides ex auditu/ auditus autem per verbum Christi}
...
In these efforts to make \q{the word of Christ} to be heard and believed, then, what was the role of music?
...
The music for villancicos covered a wide stylistic range from old-style polyphonic techniques to highly rhythmic music drawing on dance traditions, as in \ti{A la jácara, jacarilla} (\musicexample \ref{mus:Padilla-A_la_jacara_jacarilla}).

\begin{musicexample}
%\includegraphics{Padilla-A_la_jacara_jacarilla}
\caption{\ti{A la jácara, jacarilla}, setting by Juan Gutiérrez de Padilla (Puebla, 1653)}
