...
singing}.%
    \Autocites
    {Murata:Singing}
    {Illari:Polychoral} % XXX page number
...
feeling of stresses grouped in twos rather than threes (this is
...
interpretation.%
\begin{Footnote}
    This study builds on the initial movements in this direction in
    \autocite{Laird:VC} and \autocite{Illari:Polychoral}.
\end{Footnote}
Despite its rich potential as sources for studies in several disciplines
...
Ledesma in his \wtitle{Conceptos espirituales} of 1600.%
   \Autocites
   [227--228]{Gaylord:Poetry}
   {Valbuena:Literatura}
   [447--447]{Torrente:VC-chapter}
...
\end{Footnote}
Like clarion pieces, these are abstractions of the music they reference; they
are not meant for dancing, but provide a discourse about dancing.%
\begin{Footnote}
...
In part this no doubt served purposes of entertainment but it also demonstrates
an effort to find common ground between classes, to use the lowly elements of
society to make hearers rethink that which was lofty.
...
Encarnación), retains the earlier emphasis on ingenuity---the piece is composed
algorithmically from permutations of a set poetic and musical phrases---but has
lost all stylistic references to the secular \term{jácara}.%
...
Though the \wtitle{Anton Llorente} pieces present no learned doctrines, they
still serve a religious function in prompting hearers to laughter and
enjoyment, and that function contributed to the effect of a set of villancicos
within the liturgy.%
...
almost entirely of solmization syllables: \foreign{y ella al sol mire y la
mire el sol}.
