...
into a new relationship with each other.%
   ...
   {Valbuena:Literatura}
   {Torrente:VC-chapter}
The technique was pioneered by Alonso de Ledesma in his \wtitle{Conceptos
espirituales} of \XXX[1610].%
    \citXXX[english dude]
...
someone could yell \quoted{Fire} in a crowded cathedral.%
    \citXXX[external evidence]
A villancico like \wtitle{Al arma, al arma, que suene el clarín} is
...
performed by the boy choristers known as \term{seises}, but more research is
