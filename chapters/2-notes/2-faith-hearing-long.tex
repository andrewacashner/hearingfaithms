...
{\quoted{Judaism}, in Calderón, \worktitle{El nuevo palacio del Retiro}, 1634}
...
When the Eucharistic host is consecrated and elevated, Judaism responds with a long monologue (\expoemref{expoem:Calderon-Retiro-Judaismo}) in which he attempts to understand the mysterious wafer by connecting it with stories from Hebrew Scripture such as the manna in the desert and the dew on Gideon's fleece.\citXXX[bible passages]
...
Earlier in the play, each personified sense competes for a laurel prize awarded by Faith (\expoemref{expoem:Calderon-Retiro-Hearing}).
...
The estribillo (\expoemref{expoem:Si_los_sentidos-Sanchez-estribillo}) sets the scene as a competition or public debate between the senses, where each sense will receive a \quoted{hearing} before Faith.
...
Each of the coplas treats a different sense (\expoemref{expoem:Si_los_sentidos-Sanchez-coplas}).
...
%**************
\inputquotepoem{Oigan_todos_del_ave-Galan}
%**************
...
\inputquotepoem{Atender_sin_mirar-Soler}
...
\inputquotepoem{Atender_sin_mirar-Soler-coplas}
...
Padilla's introducción (\expoemref{expoem:Oyeme_Toribio-Padilla}) and coplas present dialogues between the friar and the deaf man, while in the estribillo the five-voice chorus (probably SATB of Chorus I with the instrumental Bassus of Chorus II) comments on the scene and gives it theological meaning.
...
The piece mocks his difficulty hearing much like Padilla's did, but it also contrasts this ersatz humanistic scholar's book learning with true faith (\expoemref{expoem:Pues_la_fiesta-Ruiz-estribillo}).
...
The relatively sympathetic treatment of the deaf man continues in the coplas, which present a comically failed catechism lesson (\expoemref{expoem:Pues_la_fiesta-Ruiz-coplas-1}).
...
He hears \gloss{profeta}{prophet} as \gloss{estafeta}{mailman}.
Hearing the word \foreign{parte} he thinks the catechist is asking about the God Mars (\foreign{Marte}).
In another (\expoemref{expoem:Pues_la_fiesta-Ruiz-coplas-2}), when the catechist lauds the \gloss{bailes}{dances} of Christmas, and says \gloss{el portal es nuestro alivio}{the stable is our remedy}, the deaf man thinks he is citing \foreign{Tito Libio}.
...
If we critique villancicos as ineffective religious teaching, though, we still reinforce the notion that the purpose of villancicos was indoctrination.
...
Villancicos do not so much present propositions (such as could be accepted with simple belief, \term{fides informe}) as celebrate the objects of faith in particular ways.\citXXX[see later chapter]
