...
Churchgoers in the Spanish Empire of the seventeenth century were familiar with
...
Whether Catholic teachers were speaking to \quoted{heretics} or \quoted{pagans};
whether debating the meaning of \emph{faith} with Protestants or trying to find
the right word to translate it for Mexica peasants or Mandarin philosophers---in
many cases Catholics found themselves, knowingly or not, in \quoted{dialogues of
the deaf}.%
\begin{Footnote}
...
the cathedrals.
% Jesuits in Europe, for example, used music and theater to train the youth of the
% nobility to follow in the Catholic flock, while their missionary brothers
% overseas adapted Iberian folk songs to indigenous languages.%
%     \Autocites
%     %{Castagna:JesuitsConversionBrazil}
%     {Waterhouse:EarliestJapaneseContacts}
% The Franciscans in New Spain formed choruses of indigenous boys and established
% the foundation of a rich musical culture in the new colony.%
...
\quoted{formed faith} (\emph{fides formata}), which \quoted{worked through} hope
and love to result in  what might best be translated as \quoted{faithfulness}.
...
(\scripture{ITm}{2:12}); so that \quoted{whether one sets out to believe or
...
or the peasants of Europe whose customs were still more pagan than Christian.%
    ...
    % XXX RLK on "shared culture of Iberian and New World cathedrals"
...
\begin{quoting}
    ...
    joyful things are true.%
        \Autocite[\range{bk}{7}, \pagenum{550}. 
...
Spanish theological writers like Ignatius of Loyola (\circa{1491}--1556) and
John of the Cross (Juan de la Cruz \circa{1542}--1591) cultivated disciplines
for regulating spiritual experiences and submitting individual sensation to the
Church's authority, in an environment where mystics who claimed authority on the
basis of sensory experience could find themselves before the Inquisition.%
    \Autocites[\range{ch}{6}]{Schreiner:Certainty}
...
John of the Cross taught contemplatives to pursue union with God by weaning
themselves of sensory experiences in the \quoted{dark night of the soul}.
He defines that union not in sensual terms but in ethical ones, as the total
surrender and conformity of one's will to God.%
    \Autocite
    [\range{bk}{I}, \range{ch}{5--7}, \pagenums{226--248}]
    {JuandelaCruz:Subida} % Carmelite secondary
John's writings represent a stark extreme on the side opposed to religious
music, in \wtitle{The Ascent of Mount Carmel}, a treatise on spiritual life
written for Discalced Carmelite monks in the 1580s (published after 1618).
The reformer complains that even though churches would seem the ideal place for
prayer, their decorations, ceremonies, and music so engage a person's senses
that it can be impossible to worship God \quoted{in spirit and in truth}
(\scripture{Jn}{4:23--24}).%
    \Autocite
...
like music, only serves to stimulate \quoted{the sense and understanding}---John
...
mystical experience, this passage seems to deliberately echo the \quoted{love}
...
be}.%
    \Autocite
    [\range{bk}{2}, \range{ch}{22}, \pagenum{306}]
    {JuandelaCruz:Subida}

Half a century later, Athanasius Kircher's ecstatic writing about the power of
music when added to preaching, reflects no such anxiety about the danger of
music.
...
% XXX RLK slippage between central Roman dictates, local cathedral practice,
% shifting Jesuit attitudes toward music
...
% \emph{Judaísmo} represented the unbelieving Jew---the children of Abraham in
% flesh only;
% he contrasted with another stock character, \quoted{Hebraísmo}, those
% proto-Christian Israelites who believed God's promise of a Messiah and were
% children of Abraham's faith.%
%     \citXXX[Nemiroff]
%     % XXX etc on Romans; "faith comes by hearing" passage is about the Jews
...
% XXX RLK transition back to mainland?
...
%{{{4 poems Sanchez Si los sentidos
...
%{{{4 music Irizar si los sentidos
...
%{{{4 music Carrion Si los sentidos
...
% XXX RLK anything specific to Segovia?
...
{The senses and faculties of the sensible soul (\emph{ánima sensitiva}),
...
purposes.
We have already seen in the previous chapter % XXX \cref{ch:intro} 
that many villancicos feature auditory \quoted{special effects} like echoes,
voices imitating instruments, and voices imitating birdsong.
...
%{{{4 poem Galan Oigan todos del ave
...
Puebla Cathedral in New Spain, and the other is by Matías Ruiz for the Royal
Chapel in Madrid.
...
The Christmas Matins service at the Cathedral of Puebla de los Ángeles in 1651
included a piece beginning \emph{Óyeme, Toribio}, labeled \emph{sordo} in the
partbooks. 
Here Juan Gutiérrez de Padilla created a comic dialogue between a religious
teacher and a \quoted{deaf} man named Toribio
...
% XXX RLK did oratorio pay musicians?
...
and a \emph{simple}---a learned man and a simpleton---Gutiérrez de Padilla's
villancico stages a parody of the question--answer practice of catechetical
instruction.
...
\begin{Footnote}
    In the manuscripts, \emph{dúo} means a single voice at a time with a single
...
\emph{¿Eh? ¿eh? que no te oigo} (Huh? huh? I can't hear you).
The two men interrupt each other and cannot follow each other's train of
thought.

%{{{4 music GdP Oyeme Toribio
...
The composer illustrates the men's disagreement by having them fail to concur on
where to cadence.
...
unwilling to hear}.%
    \Autocite
    [\sv{sordo}{SORDO, Lat. surdus, el que no oye. No ay peor sordo que
...
%{{{4 poems Pues la fiesta Ruiz 1 & 2
...
%{{{4 figure Covarrubias ears
\insertFigure{Covarrubias-Emblemas-202-ears-thorns}
{\quoted{Make a hedge around your ears with thorns}, from Covarrubias,
\wtitle{Emblemas}, 202}
%}}}4
