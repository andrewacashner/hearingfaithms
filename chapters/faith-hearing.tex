...
\term{sordo}, a deaf or hard-of-hearing man.
...
\begin{Footnote}
    Poetry imprint, \sig{E-E}{Mús. 83-12};
...
In fact, the \term{sordo} follows this introductory dialogue by declaring his
...
\foreign{que sordos son/ los que no escuchan ni entienden el son} (for the deaf
...
parts, \wtitle{Villancico de los sordos}---using the plural for \term{deaf} even
though there is only one character labelled \foreign{sordo} in the piece.
%}}}2
...
whether debating the meaning of \term{faith} with Protestants or trying to find
...
The setting of the opening phrase suggests a tone of \XXX[hushed awe]: the
voices sing relatively low in their registers, with a slow harmonic rhythm, and
pause for prominent breaths (\measures{1--9}).
...
For \foreign{qué equivocación} (\quoted{what confusion!}) Galán creates a sudden
...
vernacular \wtitle{Introduction to the Creed} of 1583.%
...
\quoted{formed faith} (\term{fides formata}), which \quoted{worked through} hope
...
\begin{Footnote}
    The Spanish word \foreign{oído} could mean both \quoted{hearing} and
    \quoted{ear}, much like the Greek word \foreign{akoē} translated as
    \quoted{hearing} in \scripture{Romans}{10:17}.
\end{Footnote}
...
ten-part treatise, including a detailed analysis of \quoted{whether, why, and
what kind of power music might have to move people's souls, and whether the
stories are true that were written about the miraculous effects of ancient
music}.%
...
Inquisition; other women like Francisca \citXXX[de los Ángeles] were not so
...
Teresa's pupil John of the Cross (Juan de la Cruz, \circa{1542}--1591)
...
all.
He defines \quoted{union with God} not in sensual terms but in ethical ones, as
...
The Spanish ex-soldier Ignatius of Loyola (\circa{1491}--1556) taught priests
...
in \XXX[some places]), and did little to stem the tide of Catholic arts in the
...
Kircher's missionary colleagues knew this problem all too well.
...
termed the \quoted{missionary tropics}---both a geographic zone and a process
...
ritual.%
    \citXXX[spiritual conquest of Spain etc.]
...
included a piece beginning \foreign{Óyeme, Toribio}, labeled \foreign{sordo} in
the partbooks. 
...
chapter, the \wtitle{Villancico de los sordos} by Matías Ruiz from 1671
Madrid.
...
understand the sound}, they use the term \term{son}, which the dictionary of
