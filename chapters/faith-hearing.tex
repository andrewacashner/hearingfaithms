...
teaching and regulate its practice to turn the tide of Protestant revolt;
...
philosophers, Catholics found themselves, knowingly or not, in what
\XXX[scholar] has called \quoted{dialogues of the deaf}.%
...
Catholic teachers strove to accommodate the weakness of the senses and the
obstacles to intelligibility caused by differing language, culture, education,
and personal temperament. 
Meanwhile they also worked to train the senses to create the capacity to
perceive the church's teaching rightly and live accordingly.
...
linked them to the sacred in inventive ways.
Each piece provides a new, experimental answer to Christ's question,
\quoted{With what can we compare the kingdom of God, or what parable will we use
for it?} (\scripture{Mk}{4:21}).
that reflected the patterns of
...
Catholic writers taught that since faith came through hearing, as Saint Paul
...
(\scripture{1 Tm}{2:12}); so that \quoted{whether one sets out to believe or
...
reach \quoted{the conviction of things not seen} (\scripture{Hb}{11:1}, NRSV).
...
% XXX This phrase forms a pattern known in rhetorical terms as \emph{catabasis}
% as it descends in a leaping melodic sequence.
...
hedge around your hears with thorns}.%
    \Autocite
