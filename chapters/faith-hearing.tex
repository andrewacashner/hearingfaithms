...
Whether the church's teachers were speaking to \quoted{heretics} or
\quoted{pagans}; whether debating the meaning of \emph{faith} with Protestants
...
means of making faith appeal to hearing.
Jesuits in Europe, for example, used music and theater to train the youth of the
nobility to follow in the Catholic flock, while their missionary brothers in
Brazil and Japan adapted Iberian folk songs to indigenous languages.%
    \Autocites
...
But to understand how Hispanic Catholics understood themselves, we must reckon
with both ideal and reality, pristine theology and messy practice.

How, then, could cathedral chapters, religious orders, and local clergy use
...
Ignatius of Loyola (\circa{1491}--1556) provided Jesuits with his
...
John of the Cross represents a stark extreme on the side opposed to religious
...
be impossible to worship God \quoted{in spirit and in truth}
...
Athanasius Kircher's ecstatic writing about the power of music when added to
