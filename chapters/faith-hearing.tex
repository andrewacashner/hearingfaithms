...
\begin{epigraph}
    ...
    ---\quoted{Judaism}, in Calderón, \wtitle{El nuevo palacio del Retiro}%
        \Autocite[\poemline{1327}]{Calderon:Retiro} % check
\end{epigraph}

One of the many stock characters in villancicos is \emph{sordo}, a deaf or
hard-of-hearing man.
...
In 1671, one such \wtitle{villancico de los sordos} was performed by King Philip
IV's own ensemble, the Royal Chapel, for the feast of Christmas at Madrid's
...
\begin{quotepoem}
    ...
    \speaker{Catechist} Who is calling out \\
...
In fact, the \emph{sordo} follows this introductory dialogue with a pious
declaration of love for the baby Jesus, and calls on the full eight-voice
chorus to ratify a theological statement that could be interpreted as a critique
of hearing and deaf people alike: 
\begin{quotepoem}
    Pues vaya de viestas    & So on with the festivities \\
...
understand, then both characters in this scene are really \emph{sordos} (as
implied by the plural in the title of Ruíz's manuscript performing parts).

This scene of mishearing and misunderstanding is emblematic of the central
problem of the Roman Catholic Church in its efforts, after the Council of Trent,
to build Christian civilization in the newly colonized lands across the globe
and reform the European church and bolster its teaching in the face of
Protestantism.
...
\emph{faith} against Lutheran reinterpretation, or to find a suitable translation
for \emph{God} to communicate with Mexica peasants and Mandarin philosophers,
Catholics found themselves, knowingly or not, in what \XXX[scholar] has called
\quoted{dialogues of the deaf}.%
    \citXXX[dialogues of deaf]

If faith came by hearing, as Saint Paul wrote, then what kind of power did music
have to make faith appeal to hearing?
The church used music in all these evangelizing and civilizing efforts: Jesuits
in Europe used music and theater to train the youth of the nobility to follow in
the Catholic flock, while their missionary brothers in Brazil and Japan adapted
Portuguese and Spanish folk songs to indigenous languages; the Franciscans in
New Spain formed choruses of indigenous boys and established the foundation of a
rich musical culture in colonial Mexico.
All of these efforts shared two common components: accommodation and training.
They all strove to accommodate the sense of hearing, overcoming the problems of
perception that came from divides of language, culture, and education. 
At the same time, however, they also worked to train that same sense to create
the capacity to perceive the church's teaching correctly.

Villancicos were the most widespread form of religious music with words in
vernacular languages in the Catholic world of the seventeenth century, and they
...
linked them to the sacred in inventive ways that reflected the patterns of
devotion in particular communities at key moments in their life together.
In short, villancicos represent the Hispanic church's effort to use music to
make faith appeal to hearing.
They are evidence of the church working to accommodate hearing and train it at
the same time.

Villancicos spoke to a variety of people at different levels of education and
understanding.
They were composed in sets of eight of more pieces, interspersed between the
readings of Matins (either replacing or supplementing the Responsory chants) or
interpolated into other liturgies like the Mass; and each cycle of villancicos
includes an array of different subgenres that seem to speak to different
portions of the congregation, from silly dialogues of Christmas shepherds that would have
entertained children and their parents alike to elaborate metaphorical conceits
like the pieces based on musical terminology that will be studied in
\cref{part:unhearable-music} of this book.

Even the structure of individual villancicos seems to reflect the effort to
communicate on multiple levels.
The \emph{estribillo} section of a typical villancico was scored for full ensemble and
performed at the beginning and then repeated at the end of the piece; composers
usually set this in relatively complex polyphony similar to what they would do
for a motet.
...
But villancicos differ from the other dominant forms of vernacular religious
...
dialogue.
Catholics did not, generally speaking, cultivate a culture of literate,
self-advocating lay people who would have left behind traces of their personal
beliefs and devotional practices.
We know what they heard, but not what they understood or how they responded.
And when villancicos represent types of people, whether catechists, deaf men,
black slaves, or Indians, we have only conventional caricatures, not
ethnohistorical descriptions.

All the same, the devotional music that survives from imperial Spain
nevertheless provides a fascinating window into the very process of religious
communication.
For one, it is not the case that the creators of villancicos were always members
of the most elite strata: the more cultivated Spanish poets like \XXX[Francisco
de Quevedo] expressed their scorn for villancico poets, who they viewed as hacks
stringing together clichés to satisfy the tastes of a lower-class
market.\citXXX{}
The archives of the cathedrals preserve the names of chapelmasters who composed
the villancicos at these prestigious institutions, but in some cases the
settings were made by lower-ranked members of the ensemble, or are anonymous; at
least one villancico composer was of partly indigenous ancestry, Juan de Araújo
in Bolivia.\citXXX[?, Illari]
Regardless of their personal background, though, these poets and musicians were
following the demands of their local congregation, who turned out in droves to
hear the annual performances of villancicos in Matins at Christmas, Corpus
Christi, the Conception of Mary, and local saints' days.
...
Moreover, villancicos in the form of a dialogue, like most of the pieces studied
in this chapter, paint colorful pictures of the sometimes bumbling and misguided
conversations between church leaders and their parishioners.
And the many villancicos that explicitly treat themes of faith and hearing
allow us to see and hear how early modern Catholics on both sides of the
Atlantic understood music's role in making faith appeal to hearing.
As the \quoted{villancicos of the deaf} demonstrate, though, problems could
arise at every stage of the effort to communicate.
...
Above all these is the danger that both the teacher and the pupil might be deaf
to each other; that neither one could even know whether their communication had
been successful.
...
understand religious teaching, all the while poking fun at the futile efforts of
some churchmen to make faith appeal to hearing.
