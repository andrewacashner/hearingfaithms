...
\begin{Footnote}
    Poetry imprint, \sig{E-E}{Mús. 83-12}; \autocite{Grove:Ruiz}.
\end{Footnote}
...
Granada's \wtitle{Introduction to the Creed}.
...
Council of Trent and first published in 1566.%
    \Autocites
    {Catholic:Catechismus1614} %XXX original ed?
...
of Ávila or Francisca de los Ángeles (burned at the stake in \XXX{15XX}).
    \Autocites
    {Ahlgren:TeresaPolitics}
    {Francisca:Inquisition}
    [\range{ch}{6}, \XXX]{Schreiner:Certainty}
...
\quoted{missionary tropics}---both a geographic zone and a process of troping
...
ritual.%
    ...
    \citXXX[spiritual conquest of Spain etc.; scolieri dancing]
