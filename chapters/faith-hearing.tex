...
\begin{Footnote}
    ...
    \XXX[MacGaffey:DialoguesDeaf]. %XXX add, read
\end{Footnote}
...
rich musical culture in the new colony.%
    \citXXX[Jesuits Brazil, Japan, Franciscan choirs, Da Gante, Sahagun, Mexican
    colonial music; Chakravarti:LanguageOfLand; Kittya Lee]
...
and in fact the more cultivated Spanish poets like Francisco de Quevedo mocked
the authors of villancicos as hacks stringing together clichés to satisfy the
tastes of a lower-class market.%
    \citXXX{}
...
\begin{Footnote}
    There is evidence \XXX[where?] that villancicos were sometimes staged, even
    with costumes, but the practice varied locally and more research is needed
    into this question.
...
Catholic defenders like Thomas More accused Martin Luther of turning his
followers away from the trustworthy institutional Church with its objectively
operating sacraments.%
    \citXXX[More, Responsio ad Lutherum, 1523]
According to this polemic, Luther left his flock with only a subjective
experience as assurance of salvation, and separated individual faith from the
cultivation of a just society.%
    \Autocite[\range{ch}{4}]{Schreiner:Certainty}
For this reason the theologians who wrote the catechism of Trent were careful to
distinguish individual sensation from the true knowledge of God.
In the tradition of Augustinian Neoplatonism, the catechism declares that God is
greater than anything that can be sensed:
...
do}.%
    ...
    {Catholic:Catechismus1614}
Faith thus requires a person to go beyond the senses, to reach \quoted{the
conviction of things not seen} (\scripture{Hb}{11:1}).

But even as the catechism stresses that the knowledge of God can only come
through God's gift, it still speaks of faith in subjective terms.
Faith, it says,  means more than having an opinion or conception of
something---it \quoted{has the strength of the most certain agreement, such that
