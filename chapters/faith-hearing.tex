...
\begin{Footnote}
    ...
    (\autocite[\sv{dialogue}]{OED}). % XXX add
    Wyatt MacGaffey has applied it to early European encounters with Africans,
    \citXXX[MacGaffey:DialoguesDeaf]. %XXX add, read
\end{Footnote}
...
faith, and who lived out their faith together as part of a harmonious society.%
    \citXXX[Dell'Antonio, sound studies?]
...
lower-ranked members of the ensemble, and at least one villancico composer in
America was of partly indigenous ancestry (Juan de Araújo in
Bolivia).%
    \citXXX[?, Illari]
...
accounts turned out in droves to hear the annual villancico performances.%
...
by Joan Cererols), \emph{Callar y creer}---literally, shut up and believe.%
    \citXXX[Cererols, Serrana tu que en los valles]
...
\begin{Footnote}
    There is evidence that villancicos were sometimes staged, even with
    costumes, but the practice varied locally and more research is needed into
    this question.\citXXX{}
...
Devotional music of the era after Trent should be understood as part the
...
\begin{quoting}
    ...
    (\scripture{1Jn}{2:2}).%
        ...
        {Catholic:Catechismus1614}
\end{quoting}
The catechism counters the Protestant disregard for good works (as misunderstood
by Catholics) by insisting that \quoted{in this we know that we know him, if he
keep his commandments}
(\scripture{1 Jn}{2:3}). 
Therefore teachers should model faithful living, \quoted{not in leisure} but
\quoted{in applying diligent effort to justice, piety, faith, charity, mercy},
having been redeemed \quoted{to do good works} (\scripture{1 Tm}{2:12}); so that
...
should be the summit of all Christian life.%
    ...
    \Dots{}}.]
    {Catholic:Catechismus1614}
The goal of evangelism, then, was not only to instill belief but to inculcate
faithfulness, devotion, and ultimately love within the community of the Church.
...
Indeed, with the threat of heresy all around, Catholic teachers did not want
