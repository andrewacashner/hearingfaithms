...
a feud with the devil---in one case, he comes \quoted{from way up in Texas}.
...
\begin{diagram}
    ...
    \includegraphics[width=\linewidth]{Padilla-Miraba_el_sol-hexachords}
...
triple meter to duple (\meterC{} or \term{compasillo}), and creates a cascading
