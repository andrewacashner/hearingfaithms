...
expanding global domains of the Spanish crown (see \mapref{map:iberia} and
...
\index{faith}
\index{hearing|seealso{listening}}
\index{listening}
\index{Trent, Council of}

%{{{4 maps
\begin{map}
    \caption{Iberia, major cities and regions, \circa{1650} (modern borders
    shown)}
    \label{map:iberia}
    \includefloat{iberia}
\end{map}
...
\begin{map}
    \caption{Spanish America, major cities and regions, \circa{1650}}
    \label{map:spanish_america}
    \includefloat{spanish_america}
\end{map}
%}}}4
...
listen---\foreign{escuchad}, \foreign{oíd}, \foreign{atended}---and many
...
\index{metamusical|see{music about music}}
\index{music about music}
\index{villancico!definition}
...
\index{theology!as performed}
\index{Seeger, Charles}
%}}}2
...
(\poemref{poem:En_la_gloria_de_un_portalillo-Padilla-1652}), the villancico
...
\index{Padilla, Juan Gutiérrez de|see{Gutiérrez de Padilla, Juan}}
...
\begin{poemexample}
    ...
    \includegraphics{En_la_gloria_de_un_portalillo-Padilla-1652}
\end{poemexample}
%}}}5
...
\begin{Footnote}
    ...
    two minims in a measure of \meterC{} time (\term{tiempo imperfecto menor});
    \autocites
...
\index{villancico!musical genre}
\index{Cerone, Pedro}
\index{Lorente, Andrés}
\index{music theory}
\index{rhythm}
\index{CZ meter|see{rhythm}}
\index{solmization}

%{{{5 music GdP portalillo start
\begin{musicexample}
    \caption{Gutiérrez de Padilla, \wtitle{En la gloria de un portalillo}
    (\sig{MEX-Pc}{Leg. 1/2}, Christmas 1652), estribillo}
    \label{mus:Padilla-Portalillo}
    \includefloat{Padilla-Portalillo}
\end{musicexample}
%}}}5
...
\index{affects}
\index{listening!affective response}
...
\index{theology!devotional!as opposed to doctrinal}
\index{villancico!social function!festivity}
...
interpretation.
Despite the genre's rich potential to inform several disciplines including
literary studies, religious studies, and musicology, few scholars have sought
to understand this music in the theological context for which it was created,
...
evidence rather than on musical texts, whether because of a lack of sources or
...
particular the Church's promotion of slavery and social inequity.
...
pushed to the brink of incomprehensibility; but both approaches were well
...
\index{Ledesma, Alonso de}
\index{villancico!poetic genre}
\index{Ricoeur, Paul}
...
from sources in nine archives in Mexico, Spain, Germany, the United Kingdom,
...
(The simpler folkloric Christmas carols denoted by \term{villancico} today
...
(They were less common in Holy Week, but there are examples of \quoted{Passion}
villancicos.)
...
\index{villancico!definition|(}
\index{villancico!history}
\index{villancico!liturgical function}
\index{villancico!dedications}
...
broadsheets (\term{pliegos sueltos}) that advertised or commemorated the
...
\index{villancico!sources!poetry imprints}
...
\index{villancico!musical genre!scoring}
\index{performers}
\index{\emph{bajón}}
\index{dulcian|see{\emph{bajón}}}
\index{villancico!scoring}
\index{villancico!poetic genre!languages}
...
The estribillo, by contrast, would appeal more to the cultivated elite,
as it was often much more complex and drew on traditions of learned
counterpoint.

\index{villancico!structure}
\index{\emph{estribillo}|see{villancico!structure}}
\index{\emph{coplas}|see{villancico!structure}}
\index{villancico!audiences}
\index{villancico!social function!communication}
...
\index{heavenly music}
\index{imitation}
\index{\emph{musica instrumentalis}|see{Boethius}}
%}}}2
...
\index{creation}
\index{reference}
\index{reference|seealso{metaphor}}
\index{theology!of natural world|see{creation}}

%{{{5 music CasedaJ Sagrado pajarillo
\begin{musicexample}
    \caption{Bird-like trills in Cáseda, \wtitle{Sagrado pajarillo}, excerpt
    from the estribillo, Tiple I-1}
    \label{mus:CasedaJ-Sagrado_pajarillo}
    \includefloat{CasedaJ-Sagrado_pajarillo}
\end{musicexample}
%}}}5
%}}}3
...
\index{Puebla!Cathedral}
\index{\emph{tamboríl}}
\index{\emph{castañuela}}

%{{{5 music GdP Alto zagales chaz
\begin{musicexample}
    \caption{Gutiérrez de Padilla, \wtitle{Alto zagales de todo el ejido}
    (\sig{MEX-Pc}{Leg. 2/1}, Christmas 1653), estribillo: Imitation of
    castanets and tabor}
    \label{mus:Padilla-Alto_zagales-chaz}
    \includefloat{Padilla-Alto_zagales-chaz}
\end{musicexample}
%}}}5
...
\index{Durango, Matías}
\index{Romero, José de}
\index{El Escorial, Real Monasterio de San Lorenzo}
\index{Madrid!Royal Chapel}
\index{\emph{Capilla Real}|see{Madrid!Royal Chapel}}
\index{\emph{clarín}}
\index{clarion|see{\emph{clarín}}} 
\index{\emph{auto sacramental}}
\index{drama!sacred|see{\emph{auto sacramental}}}
\index{musical topics!military}
\index{\emph{batalla}|see{musical topics!military}}
\index{villancico!social function!project political power}

%{{{5 music: clarin in voice vs actual, durango/durón
\begin{musicexample}
    \caption{Matías Durango, \wtitle{Cajas y clarines} (\sig{E-E}{Mús. 29/15},
    Tiple I-1, estribillo): Imitation of \term{clarín} by voice and shawm}
    \label{mus:Durango-Cajas_clarines}
    \includefloat{Durango-Cajas_clarines}
\end{musicexample}

\begin{musicexample}
    \caption{Sebastián Durón, \wtitle{Dulce armonía} (\sig{E-E}{Mús. 32/16},
    estribillo): Extant \term{clarín} part}
    \label{mus:Duron-Dulce_armonia_clarin}
    \includefloat{Duron-Dulce_armonia_clarin}
\end{musicexample}
%}}}5
...
moments of civic importance, signaling a call to arms, announcing victory,
or heralding the arrival of the king or his representative.
...
The clarín was used in military, royal, and apocalyptic symbolism as far
...
Galán (from \circa{1691}), the voices represent clarín music in a scene
...
\index{Philip the Fair}
\index{musical instruments, symbolism}
\index{theater}
\index{theater!\emph{comedia}}
\index{drama!secular|see{theater}}
...
A long struggle over this border territory in the War of the Grand Alliance
climaxed in the year this villancico was performed, as the French marshal 
...
\index{Girona}
\index{sanctoral devotion!Francis}
\index{convent music}
\index{Catalonia}
\index{France}
\index{villancico!dedications!profession of nun}
...
significance theologically than the mere sound of the actual instrument.
...
\begin{Footnote}
    \sig{D-Mbs}{Mus. ms. 2895}; in \autocite[127--128]{Hidalgo:Tonos}.
...
\begin{poemexample}
    \caption{\wtitle{Venid querubines alados}, poem set by Hidalgo
    (\sig{D-Mbs}{Mus. ms.  2895}), copla 5}
    \label{poem:Venid_querubines_alados-Hidalgo}
    \includefloat{Venid_querubines_alados-Hidalgo}
\end{poemexample}

\begin{musicexample}
    \caption{Hidalgo, \wtitle{Venid querubines alados}, duo response at end of
    each copla} 
    \label{mus:Hidalgo-Venid_querubines}
    \includefloat{Hidalgo-Venid_querubines}
\end{musicexample}
%}}}5

Raúl Angulo Díaz has shown that this is one of several sacred reworkings of a
\term{tono humano} of 1673, \wtitle{Venid a la olímpica lucha} from the second
act of the drama \wtitle{Los juegos olímpicos} by Agustín de Salazar y
Torres.%
    \autocite[25--35]{Hidalgo:Obras}
In the original the voices became \foreign{el clarín de la fama}, \quoted{the clarion
of fame} heralding the sporting victor.
As a \term{tono divino}, the piece now transforms the civic, military, and
...
an \quoted{instrument of dominion} while also acknowledging that many Spanish
...
\index{\emph{zarabanda}}
\index{\emph{jácara}|(}
\index{\emph{guarache}|see{\emph{huarache}}}
\index{\emph{danza de espadas}}
\index{\emph{papalotillo}}
\index{Seville!Cathedral}
\index{Valencia!Cathedral}
\index{Corpus Christi}
\index{Comes, Juan Bautista}
...
celebrating the exploits of renegade heroes with colorful and often bawdy
underworld slang.%
    \Autocites
    {Torrente:Jacara}
...
a feud with the devil---in the one from 1655, he comes \quoted{from way up in
Texas}.  
...
jacarilla} (1653), every line of the coplas is built from \foreign{principios
...
\index{Christ!as outlaw hero}
\index{Gutiérrez de Padilla, Juan}
\index{Puebla!Cathedral}
\index{\emph{romance} poetry}
\index{villancico!social function!entertainment}
...
The texts use a smattering of foreign words but mostly ask the performers
...
\index{\emph{negrilla}|see{villancico!ethnic}}
\index{\emph{villancico de negro}|see{villancico!ethnic}}
\index{caricature}
\index{humor}

%{{{5 GdP Al establo negrilla
\begin{musicexample}
    \caption{Gutiérrez de Padilla, \wtitle{Al establo más dichoso
    (Ensaladilla)} (\sig{MEX:Pc}{Leg. 2/1}, Puebla Cathedral, Christmas 1652),
    \term{Negrilla} section, dialogue of the Angolans}
    \label{mus:Padilla-Al_establo-Negrilla}
    \includefloat{Padilla-Al_establo-Negrilla}
\end{musicexample}
%}}}5
...
Black characters say \quoted{Listen, for we are singing like the angels}.%
...
\index{Magi}
\index{rhythm}
\index{Africans!Angola/Congo}
\index{slavery}
\index{Neoplatonism}
\index{villancico!social function!project political power}
\index{villancico!social function!reinforce colonial structure}

%{{{5 music GdP Al establo Gloria
\begin{musicexample}
    \caption{Gutiérrez de Padilla, \wtitle{Al establo más dichoso} (1652),
    \term{Negrilla}: Polymetrical \term{Gloria} of Angolans (Choir I) and
    angels (Choir II)} 
    \label{mus:Padilla-Al_establo-Gloria}
    \includefloat{Padilla-Al_establo-Gloria}
\end{musicexample}
%}}}5
...
\index{Africans!Black Kings Festivals}
\index{Epiphany}

The villancicos, though, were created by Spaniards primarily for other
Spaniards.%
\begin{Footnote}
    Carmen Fracchia argues that \term{villancicos de negro} were originally
    created by African authors and only later appropriated by Spanish poets.
    Though much more research is needed, it seems most likely that the
    \quoted{black} villancicos sung in Spanish churches in the seventeenth
    century were written, set to music, and performed by Spaniards.
    I disagree with the way Fracchia uses my interpretive suggestions as
    though these pieces represent authentic Black voices, rather than Black
    \emph{characters} imagined by Spaniards.
    \Autocite[17--32]{Fracchia:Black}.
\end{Footnote}
...
\index{identity}
\index{villancico!ethnic|)}
\index{villancico!social function!appease consciences of slaveholders}
%}}}3
...
\index{Cervantes Saavedra, Miguel de}
\index{Toledo Cathedral}
\index{Puebla!Convento de la Santísima Trinidad}
\index{theater!minor}
\index{\emph{entremés}|see{theater!minor}}
...
\index{Santiago, Francisco de}
\index{Seville!Cathedral}
\index{João IV of Portugal}

%{{{5 music Anton Llorente
\begin{musicexample}
    \caption{Anonymous, \wtitle{Anton Llorente y Bartolo}
    (\sig{MEX-Mcen}{CSG.014}), first stanza of introducción and beginning of
    responsión (accompaniment omitted)} 
    \label{mus:Anton_Llorente}
    \includefloat{Anton_Llorente}
\end{musicexample}
%}}}5
...
\begin{Footnote}
    \wtitle{Quejosos de la sentencia que dio el alcalde Pasqual}, in imprint
...
\index{Ruimonte, Pedro}
\index{Fernández, Gaspar}
\index{Fernandes, Gaspar|see{Fernández, Gaspar}}
...
\term{sol}.%
\begin{Footnote}
    \sig{E-Zac}{B-11/233}, \ptitle{Villancico de Oposición en Zaragoza}, 
...
In Aguilar's \wtitle{Mi sol nace}, the words have a dual function: on one side
...
\index{music theory!Guidonian hexachords}
...
\begin{musicexample}
    \caption{Irízar, \wtitle{Qué música celestial} (\sig{E-SE}{18/36}, Segovia
    Cathedral, Christmas 1678), opening}
    \label{mus:Irizar-Que_musica_celestial}
    \includefloat{Irizar-Que_musica_celestial}
\end{musicexample}
%}}}5
...
Gutiérrez de Padilla, \wtitle{Miraba el sol el águila bella}.%
    \footnote{\sig{MEX:Pc}{\range{Leg}{34}}.}
...
solmization syllables, as in \foreign{ella al sol mire y la mire el sol}.
...
\caption
    ...
    \term{naturalis} on C; \term{MOL}, \term{mollis} on F; \term{DUR},
    \term{durus} on G; \term{FIC}, \term{ficta} alteration}
    
    \label{mus:Padilla-Miraba_el_sol-estribillo}
    \includefloat{Padilla-Miraba_el_sol-estribillo}
\end{musicexample}
%}}}5 
...
\begin{diagram}
    \caption{Gutiérrez de Padilla, \wtitle{Miraba el sol}, estribillo:
    Hexachordal shift symbolizing Mary/Eagle in \term{mollis} turning to
    Christ/Sun (\term{sol}) in \term{naturalis}}
    \label{dia:Padilla-Miraba_el_sol-hexachords}
    \includegraphics[width=\linewidth]{Padilla-Miraba_el_sol-hexachords-standalone}
%    \includegraphics[width=\linewidth]{Padilla-Miraba_el_sol-hexachords-music}
\end{diagram}
%}}}5
...
Christ (\term{Ecce ancilla}, \scripture{Lk 1:46-55}), and ends on the
...
\index{Juana Inés de la Cruz, Sor}
\index{sanctoral devotion!Mary}
\index{Mary, Virgin|see{sanctoral devotion!Mary}}
\index{music theory!symbolism}
\index{ingenuity}
\index{reading}
...
\begin{poemexample}
    \caption{Sor Juana Inés de la Cruz, \wtitle{Silencio, atención, que canta
    Mariá}, excerpts (Spanish text from Méndez Plancarte edition)}
    \label{poem:Silencio_Maria-Sor_Juana}
    \includefloat{Silencio_Maria-Sor_Juana}
\end{poemexample}
%}}}5
...
intricate settings.
Each chapter in \partref{part:unhearable-music} traces a family of related
...
\begin{musicexample}
    \caption{Salazar, \wtitle{Angélicos coros con gozo cantad}
    (\sig{MEX-Mcen}{CSG.256}), opening}
    \label{mus:Salazar-Angelicos_coros-1}
    \includefloat{Salazar-Angelicos_coros-1}
\end{musicexample}
%}}}5
...
The call to the angels is sung first by the Tiple I-1, in a gesture beginning
...
\measure{3}, Tiple I-2 in canonic imitation, and Alto I harmonizing with it
homorhythmically. 
...
For the command \foreign{bajad} (come down), Salazar switches from \meterCZ{}
triple meter to duple (\meterC{} or \term{compasillo}), and creates a cascade
of counterpoint passing from voice to voice, moving from high F\octave{5} down
to C\octave{3} (\musref{mus:Salazar-Angelicos_coros-2}).
...
\begin{musicexample}
    \caption{Salazar, \wtitle{Angélicos coros con gozo cantad}
    (\sig{MEX-Mcen}{CSG.256}): Angels descending in imitative counterpoint}
    \label{mus:Salazar-Angelicos_coros-2}
    \includefloat{Salazar-Angelicos_coros-2}
\end{musicexample}
%}}}5
...
of the Incarnation.%
    \Autocite[65--95 (\sig{MEX-Plf}{32080-41030403})]{SanMiguel:Sermones}
...
\index{confraternities}
\index{sanctoral devotion!Michael, Archangel}
\index{villancico!social function!edification for learned elite}
\index{solmization}
\index{preaching}
\index{Andrés de San Miguel, Andrés}
...
\index{\emph{conceptismo}!musical}
%}}}2
%}}}1
...
\index{Boethius}
\index{\emph{musica instrumentalis}|see{Boethius}}
\index{\emph{musica humana}|see{Boethius}}
\index{\emph{musica mundana}|see{Boethius}}
\index{Lorente, Andrés}
\index{Cerone, Pedro}
...
\begin{table}
    ...
    \includefloat{Neoplatonic-hierarchy-music}
\end{table}
%}}}5
%}}}2
...
Luis de Granada begins his \wtitle{Introduction to the Creed} with an
...
\index{creation}
\index{book of nature|see{creation}}
\index{Augustine, Saint}
\index{Granada, Luis de}
\index{reading}

The reason one can \quoted{read} God through nature, Granada teaches, is that
...
which everything fits together \foreign{con sumo concierto} (with the most
perfect concord).
All the created things in this world, Granada writes, \quoted{like concerted
...
The movement of the heavenly spheres is like a great \quoted{chain, or, it
can be said, this dance, so well ordered, of the creatures, and like music for
diverse voices \Dots.
...
\index{theology!of music}
\index{performers!chapelmasters}

When Granada compares the world to music \quoted{in diverse voices} he
...
voices \Dots}, Granada writes, \quoted{rather their speech and testimony is
...
Luis de Granada also ventures an explanation of the human voice in both
...
Granada sees speech as something \quoted{added} to the voice, which makes it
...
six volumes on \wtitle{Rhetorica ecclesiastica}---says that the main task of
...
\index{chain of being|seealso{Neoplatonism}}
%}}}2
%}}}1
