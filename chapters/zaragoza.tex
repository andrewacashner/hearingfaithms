...
In the poem, the soul professes its rapturous love for \quoted{the living flame of love} with which the soul is burning (\cref{poem:John-Llama-opening}).
...
John uses fire to represent the soul's purification and transformation, while
...
\quoted{This flame of love}, John writes, \quoted{is the spirit of \add{the
...
John explains that \quoted{the difference between the habit and the act is that
...
In all of these sources, and most especially in the villancico set by Bruna,
the soul is giving itself to God as a burnt offering. 
The missing element is to understand why the voice is likened to flames.
