...
% TODO improve conclusions; social aspects
%}}}3
%}}}2
%}}}1
...
José de Cáseda's Eucharistic villancico \wtitle{Qué música divina} represents
Christ as a \term{vihuela}, or a \term{vihuela} as Christ.
...
Santísima Trinidad in Puebla.%
    \citXXX[Tello catalog]
% avoid repetition XXX
...
% TODO ? audience, slaves, status in community (somewhere)
%}}}2
...
As explained in \cref{ch:theology}, early modern physiology distinguished
...
% TODO incorporate other version of text found in notes
...
of the cithara: \quoted{Allegorically, the cithara represents the cross of
Christ; for just as the strings of a cithara are stretched out, thus Christ was
...
since the instrument is mentioned frequently in the cathedral chapter acts.%
    \Autocite{Calahorra:Zaragoza2} % XXX details
...
ensemble of the Convento de la Santísima Trinidad.%
    \autocite[44]{PerezRuiz:Aportes} % XXX check, unreliable source
...
with the pattern 7--7--7--11--11; this would seem to be a type of \term{lira}
meter, like the one used in the \wtitle{Llama de amor viva} of St. John of the
Cross.
Seven is also the number of courses on the vihuela described in the poem
(\poemline{26}).
So the poem itself is a \term{lira}, even as it describes a
...
\measures{11--15, 19--29}.
After \measure{18}, Cáseda realizes the common villancico poetic trope of
...
In the last eight compases (\measures{47--50}), the rhythmic pattern in the
voices---a minim rest and two minims---again suggests strumming (see
\cref{ex:CasedaJ-Que_musica_divina-clausulas} below).
...
strumming.
For the phrase \quoted{forma unida la alta con la baja} (\measures{62--66}),
Cáseda sets the text on multiple levels at once.
In \measures{62--63}, the Tenor sings a pedal \pitch{D}{4}, like a droning open
...
word \quoted{baja}, painting the text with a traditional madrigalism.
All of these ideas are then repeated in the next phrase, \measures{64--66}, now
...
using not just the abstract term \term{cithara}, but a particular type of
vihuela. 
...
sacramental theology for early modern Catholics, \quoted{That the true body of
Christ and his blood are in this sacrament, cannot be grasped by sensation
\add{neque sensu} nor by intellect, but by faith alone, which rests on divine
authority}.% 
    \footnote{\wtitle{Summa theologica} III, question 75, article 1; 1859 ed.
    p. 274} %XXX replace
Cáseda's copla 5, \quoted{No son a los sentidos} (\poemline{27}) seems to echo
Aquinas's phrase \quoted{neque sensu}, and certainly reflects the same
Eucharistic theology.
In Cáseda's poem (\poemline{33}), \quoted{sensation does not eat it}; for as
Aquinas explains in the same article, Christ's body is eaten in a sacramental,
not literally physical way.

From the theology of transubstantiation it would follow that music should be
...
as the character Hearing says of himself in Calderón \wtitle{El nuevo palacio
del Retiro} (discussed in \cref{ch:faith-hearing}).
...
\quoted{Of faith he is the intrument}, the poem says, \quoted{and his music
regales the ear \add{or, hearing}} (copla 2).
Coplas 3 and 4, as we have seen, describe the \quoted{music} played upon that
...
words} sound are not for the senses}---literally, they do not sound to the
senses. 
In other words, this music is not something that can be heard with the ears.
Indeed, the copla continues, \quoted{as many voices \add{or, words} as the
senses perceived from this instrument will be false} or out of tune.
...
a kind of \quoted{sacramental}, that is, something outside the seven official
...
As the Council of Trent and the Tridentine Catechism firmly emphasized,
...
As Saint Paul puts it, \quoted{For our sake he \add{God} made him \add{Christ} to
be sin who knew no sin, so that in him we might become the righteousness of
God} (II Cor 5:21, NRSV).

We have previously seen that metamusical villancicos frequently use dissonance
or being out of tune as a symbol for sin. 
In Jerónimo de Carrión's \wtitle{Qué destemplada armonía}
(chapter~\ref{ch:Segovia}), the fallen nature of humanity (that is, the
\term{musica humana}) is presented as an out-of-tune or \quoted{untempered
harmony}.  % XXX
To read Cáseda's villancico together with Carrión's, then, the reason why the
music played on Christ the vihuela sounds \quoted{false} is that in his
...
musician, that \quoted{elevates to the heavens the one who reaches it} in
...
\quoted{falsehood} to the extreme.
...
% TODO Parallel 5ths in vihuela harmonies, Princeton paper

These contrapuntal solecisms are what Bermudo, in his treatise on instruments
cited earlier about the vihuela, called musical \quoted{falsehood}.
...
\begin{quoting}
    ...
    few principles \addorig{primores}.  
    ...
    singing it they would recognize the falsehood \addorig{falsedad}.% 
        \Autocite[\folio{128v}]{Bermudo:Declaracion} 
\end{quoting}
Thus the kind of counterpoint Cáseda has written in his opening passage is
musical \quoted{falsedad}, the same term used in Cáseda's copla 5 to describe
...
Cáseda uses rhythmic \quoted{falsehood} as well: in \measures{18} Cáseda
switches from \meterC{} meter to \meterCZ{}, but never gives the listeners
a chance to hear a \quoted{normal} \meterCZ{} rhythmic pattern (such as the
flowing three-minim groups after \measure{30}). 
...
But it is in Cáseda's counterpoint that the idea of \quoted{falsehood} is
performed most strikingly. 
In the section beginning in \measure{40}, Cáseda tries out \foreign{cláusula
...
bizarre collision in \measures{36--37}.
The bottom four voices here on their own in \measures{36} would appear to be
...
of \measure{36} the top voice is an augmented fourth above the bass (F\sh{}
against C), while the Alto's E is made to seem dissonant even when by rights it
should not be.
In \measure{37} the voices manages to cadence on D, with the top voice settling
...
% TODO add example suenen las dulces cuerdas with "interlude" gap
...
\quoted{dismaying the [bodily] powers}.
...
wedge is created.
As this is happening, in \measures{41}, the Tiple I enters from out of nowhere
...
the whole passage again in \measure{46} (though with the voices rearranged).
...
singers would have inflected the written pitches using \term{musica ficta}.
...
But in a passage like the strange collision of cadences in \measures{36--37},
...
In \measure{45}, on \foreign{potencias desmaya}, the ficta situation becomes
actually impossible.
...
The fifths do recall the tuning of the vihuela's strings (\quoted{cuerdas}
being etymologically related to \quoted{acorde}), and of course fifths are
perfect consonances.
...
To give one example, in \measures{6--7}, Cáseda uses the same kind of
\quoted{Phrygian} cadence we have seen already in Cererols, Irízar, Bruna, and
Ambiela.  
% XXX example
...
These chapters have argued that villancicos that featured \soCalled{singing
about singing} began to change in function from emphasizing human music's
...
Bruna and Ambiela's variants of \wtitle{Suban las voces al cielo}, by contrast,
