...
(\cref{poem:Que_me_quemo-Pexa}), with an estribillo similar to Bruna's.%
\begin{Footnote}
...
(\cref{fig:Kircher-citharae}), the \quoted{common Cythara} has a round body and
...
Cathedral (\circa{1685}, \cref{fig:Correa-Sacristy}) specifically includes a
...
\term{clarín} villancicos discussed in \cref{ch:intro} suggests that might have
been the case).
...
of Juan de la Cruz (\cref{ch:faith-hearing}) that Spaniards had their ears so
