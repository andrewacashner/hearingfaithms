...
\addtoindex{
    Villancico!Social function!Cultivate faithfulness;
    Villancico!Social function!Create social harmony
}
...
\addtoindex{
    Judaism;
    anti-Semitism;
    mystery play|see{auto sacramental};
    faith
}
...
Judaism rejects faith (Spanish text from Paterson edition)}
%}}}5
...
\addtoindex{
    networks;
    villancico!sources!scores;
    villancico!sources!performing parts;
    senses!contests
}
...
\addtoindex{
    Villancico!Dedications!Conception of Mary;
...
\addtoindex{
    ...
    senses!taste;
    senses!touch;
    senses!hearing|see{hearing};
    senses!sight|see{sight}
}
...
\addtoindex{
    accommodation;
    hearing!training;
    theology!faith|see{faith};
    faith;
    Aquinas, Thomas;
    fides informe|see{faith};
    fides formata|see{faith};
...
\addtoindex{
    experience;
    Juan de la Cruz;
    John of the Cross|see{Juan de la Cruz};
    \AvilaT;
...
(\poemref{poem:Pues_la_fiesta-Ruiz-1}, \ref{poem:Pues_la_fiesta-Ruiz-2}).
