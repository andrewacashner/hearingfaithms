...
These pieces constitute \quoted{music about music} and as such provide as with 
...
The first, \quoted{Listening for Faith in Villancicos}, builds a foundation for 
understanding villancicos as historical sources of theological beliefs about 
sensation and faith.
The four case studies of the second part, \quoted{Listening for Unhearable 
...
The final part, \quoted{Listening for Community}, analyzes how processes of 
...
(whose \worktitle{Musurgia universalis} was read in both Mexico and Manila), 
...
Boethian concept of \term{musica humana}.
...
listeners to \quoted{experience the truth of what was said}.%
...
\soCalled{hearing} before Faith, who gives first prize to the sense Hearing.

The chapter connects these pieces to a 1634 Corpus Christi play, \worktitle{El 
nuevo palacio del Retiro}, by court poet Pedro Calderón de la Barca.%
...
dialogue dramatizing the inability of \soCalled{Judaism} to understand what 
...
The \quoted{villancicos of the deaf} by Matías Ruíz of Madrid and Juan 
...
The first, and the subject of this chapter, is \worktitle{Voces, las de la 
capilla}, set by Juan Gutiérrez de Padilla (Puebla, 1657).
...
and notes even the most venial dissonances/ in the manner of Christ, the infant 
prince [\foreign{infante}]/, as in the manner of David, the monarch}.
...
\quoted{the sign of \term{A (la, mi, re)}}, the tuning note of the 
\quoted{\term{alpha} and \term{omega}}.
...
the Christ-child as \term{Verbum infans}. 
...
The chapter compares Padilla's text to a similar one (\worktitle{Cantores de la 
capilla}) set ten years earlier by the chapelmaster of Seville Cathedral, Luis 
Bernardo Jalón, and evidence for an earlier lost setting beginning 
\worktitle{Voces, las de la capilla} by Francisco de Santiago, Jalón's 
...
% Heavenly Dissonance (Cererols)

\worktitle{Suspended, cielos} by Joan Cererols represents a family of 
...
way to \quoted{the newest consonance}, that is, \quoted{the tender sobs of a 
child} that \quoted{bear the plainchant to the angels}.
Here again, Christ is \term{Verbum infans}, but his cries are the \term{cantus 
firmus} on which the music of a new creation will be based.
...
Hollander's broader claim that this is evidence of a \quoted{disenchantment} 
...
The chapter traces the genealogy of the \worktitle{Suspended, cielos} family 
...
false}---that is, as out of tune (or perhaps, as \term{ficta} deviations from 
the gamut). 
...
lute, lyre, and cittern among the heavenly \quoted{cithara players} of 
...
passage on the phrase \quoted{various cadences} that appears to intentionally 
defy \term{musica ficta} conventions, creating a kind of impossible music.
