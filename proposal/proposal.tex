...
\subsection{Scholarly Context of the Study} % add detailed references
% similar works eg LeGuin? Feldman?
...
But this shift in emphasis marks a different trajectory than that theorized in an earlier generation by John Hollander, in his study of English poetry on music from the same period, \worktitle{The Untuning of the Sky}.
