...
Religious teachers, the catechism says, must accommodate their teaching to \quoted{the sense of hearing and intelligence} of the hearers.
...
The chapter connects these pieces to a 1634 Corpus Christi play, \worktitle{El nuevo palacio 
...
Calderón stages an extended anti-Semitic dialogue in which the figure of \soCalled{Judaism} fails to grasp what Faith tells him, as he repeats, \quoted{I have listened to Faith without faith}.
...
The chapter compares Padilla's text to a similar one (\worktitle{Cantores de la capilla}) set ten years earlier by the chapelmaster of Seville Cathedral, Luis Bernardo Jalón.
...
This gesture is clearest when he sets the phrase \quoted{listen to the newest consonance} with the last word on a prominent unprepared dissonance, which he repeats several times.
